...
bgGradients = ["linear-gradient(135deg, rgba(171,0,148,1) 0%, rgba(112,90,247,1) 100%)", "linear-gradient(135deg, rgba(1,139,169,1) 0%, rgba(0,208,218,1) 100%)", "linear-gradient(135deg, rgba(247,90,169,1) 0%, rgba(171,0,148,1) 100%)"]
