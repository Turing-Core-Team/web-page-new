...
bgGradients = ["linear-gradient(135deg, rgba(1,139,169,1) 0%, rgba(170,51,170,1) 100%)", "linear-gradient(135deg, rgba(1,139,169,1) 0%, rgba(0,208,218,1) 100%)", "linear-gradient(135deg, rgba(247,90,169,1) 0%, rgba(229,0,255,1) 100%)"]
